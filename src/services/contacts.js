...
export const getContacts = async ({
    ...
    const data = await ContactsCollection.find({ _id: userId }).skip(skip).limit(perPage).sort({ [sortBy]: sortOrder });
...
export const getContact = filter => ContactsCollection.find(filter);
